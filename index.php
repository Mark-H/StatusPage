...
<div class="container">
    ...
    <div class="alert alert-info">
        ...
        <strong>Head Up</strong> This page automatically refreshes every 30 second. Hold shift to sort by multiple
        fields
    </div>

    <div id="ajaxdata">
        <h2 style="text-align:center">Fetching Live Data, Stand By...</h2>
